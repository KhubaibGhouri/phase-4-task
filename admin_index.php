        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="alert alert-success notify" style="display: none;">
                 ...
                 <div class="alert alert-success error" style="display: none;background-color: red;">
                  <strong>Error!</strong> Given User Id or Email already exists .Please try with different userId or email  
                </div>
                
                    <div class="page-header text-center">
                        <h2>Patient Entry</h2>
                    </div>
                    <form class="form-horizontal" onsubmit="return validateForm()" method="post" action="controller/process.php" name ="reg" id="form">
                        ...
                        <div class="form-group row">
                           <div class="col-sm-2">
                              ...
                              <div class="col-md-8">
                                <input class="form-control dob" type="text" id="datepicker" placeholder="Date of Birth" name="dateofbirth" required="">
                              </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                <input id="userid" class="form-control" placeholder="User ID" type="text" name="userid" required=""  readonly>
                            </div>
                        </div>
...
<option value="Afghanistan">Afghanistan</option>
  ...
  <div class="form-group" >
                ...
                <option value="Wyoming">Wyoming</option>
                        ...
                        <input class="form-control" placeholder="Enter Your State" type="text" name="State[]" id="otherstate" >
                    </div>
                </div>
                      <div class="form-group">
                            <div class="col-sm-2">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" placeholder="ZIP Code" type="number" name="Zip" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" placeholder="Alcohol Level" type="number" name="Alcohollevel" required="" step="0.001">
                    </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-toggle="datepicker" type="text" id="datepicker1" name="proceduredate" required="" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <span class="checkbox-inline">
                            <input type="Radio"  name="status" value="Armed" required > Armed
                            &nbsp;&nbsp;&nbsp;
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <span class="checkbox-inline">
                            <input type="Radio"  name="cron_update" value="1" required > Yes
                            &nbsp;&nbsp;&nbsp;
...
<?php
    ...
    {
        echo '<script>$(".error").fadeIn().delay(10000).fadeOut();</script>';
    }
