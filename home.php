...
function getmsg($number)
{
    if ($number > 0.00  && $number <= 0.049 )
    {
       ...
       return 'GREAT JOB, YOUR ALCOHOL BLOOD LEVEL IS WITHIN NORMAL LIMITS';
         }
    else if ($number >= 0.05  && $number <= 0.099 )
    {
       
      return 'ATTENTION, YOUR ALCOHOL BLOOD LEVEL IS ABOVE NORMAL LIMITS';
         }
    else if ($number >= 0.099 )
    {
      
      return  'ATTENTION, YOUR ALCOHOL LEVEL IS SIGNIFICANTLY ABOVE ALLOWED LIMITS';
         }
}
?>
</head>
...
Welcome <?php echo $row['firstname']?> !
    ...
    border-top: 1px solid #ae90e2 !important;">The human body constantly produces small amounts of alcohol itself. Normal levels of 0.01 to 0.04 mg of alcohol/100 ml are contained in the blood. By contrast, a blood alcohol limit for driving of 0.05 per cent is equal to around 50 mg of alcohol/100 ml of blood.</p>
        	</div>
        </div>
        </div>
...
<div class="content">
            <div class="container-fluid">
                ...
                <div class="alert alert-success notify" style="display: none;">
                  <strong>Success!</strong> Profile Info Updated Successfully 
                </div>                                                                    
                    <div class="page-header text-center">
                        <h3>User Profile Info</h3>
                    </div>
                    <?php// $number=$row['Alcohollevel']?>
                     <div class="text-center" style="background-color:<?=getColor($row['Alcohollevel'])?>; margin: 30px; color:white"><?php echo getmsg($row['Alcohollevel']); ?></div>
                    <form class="form-horizontal" method="post" action="home.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="firstname" placeholder="First Name" class="form-control" name="firstname" value="<?php echo $row['firstname']?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" placeholder="Last Name" type="text" name="lastname" required="" id="lastname" value="<?php echo $row['lastname']?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                           <div class="col-sm-2">
                              ...
                              <div class="col-md-8">
                                <input data-toggle="datepicker" class="form-control dob" type="text" id="datepicker" placeholder="Date of Birth" name="dateofbirth" required="" value="<?php echo $row['dateofbirth']?>" readonly>
                              </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                <input id="userid" class="form-control" placeholder="User ID" type="text" name="userid" required="" value="<?php echo $row['userid']?>" readonly>
                            </div>
                        </div>
...
<option value="Afghanistan">Afghanistan</option>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" placeholder="ZIP Code" type="number" name="Zip" required="" value="<?php echo $row['Zip']?>">
                    </div>
                </div>
 ...
 <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" placeholder="Alcohol Level" type="hidden" name="Alcohollevel" required=""  Value="<?php echo $row['Alcohollevel']?>" readonly> <label><span style = "color: <?=getColor($row['Alcohollevel'])?>;" ><?= $row['Alcohollevel']?></span></label>
                    </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-toggle="datepicker" type="text" id="datepicker1" name="proceduredate" required="" value="<?php echo $row['proceduredate']?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <span class="checkbox-inline">
                            <input type="Radio"  name="status" value="Armed" <?php if($row['status']=="Armed"){ echo "checked";}?> disabled> Armed
                            &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="status" value="DisArmed" <?php if($row['status']=="DisArmed"){ echo "checked";}?> disabled> DisArmed
                        </span>
                    </div>
                </div>
                 <div class="form-group" style="display:none";>
                    ...
                    <div class="col-sm-8">
                        <span class="checkbox-inline">
                            <input type="Radio"  name="cron_update" value="1" <?php if($row['cron_update']=="1"){ echo "checked";}?> readonly> Yes
                            &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="cron_update" value="0" <?php if($row['cron_update']=="0"){ echo "checked";}?> readonly> No
                        </span>
                    </div>
                </div>
                <br>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <button name="update" value="update" class="btn btn-info">Update Info</button>
                    </div>
                </div>
